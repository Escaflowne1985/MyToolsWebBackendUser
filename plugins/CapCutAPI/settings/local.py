...
JWT_TOKEN = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ0b2tlbl90eXBlIjoiYWNjZXNzIiwiZXhwIjoxNzU3NTUwMDcyLCJpYXQiOjE3NTc0NjM2NzIsImp0aSI6IjE2OTg4YTFkMGIzNzQ1OGRhNDEwMDg2NWQyMTNmOWFhIiwidXNlcl9pZCI6MX0.iK7HVa8ijJ2XtQ1HQFsxjargmUD9RLXrwfv'

FIXED_BEARER_TOKEN = os.getenv(
    "FIXED_BEARER_TOKEN",
    JWT_TOKEN
).strip()
...
# 默认域名配置
DRAFT_DOMAIN = "https://capcut.mcp.datayang.cn"
...
if os.path.exists(CONFIG_FILE_PATH):
    try:
        with open(CONFIG_FILE_PATH, "r", encoding="utf-8") as f:
            ...
            if "cos_config" in local_config:
                COS_CONFIG = local_config["cos_config"]
